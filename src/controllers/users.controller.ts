...
export class UserController {
  public path = '/users'
  public user = Container.get(UserService) as UserService;
  ...
  @OpenAPI({ summary: 'Send notification' })
  async sendNotification(@Body() notification: { title: string; content: string }) {
    const messsage = await this.user.sendNotification(notification);
